        ...
        data.name
            ...
            <div class="profile-info">
              ...
              <div class="profile-meta">
                ...
                <span class="profile-meta-item">📅 ${new Date().getFullYear()}</span>
              </div>
          ...
          <div class="profile-bio" data-scroll>
            <ul> 
                ${data.bio.map((line) => `<li>${line}</li>`).join("\n")}
            </ul>
          </div>
            ...
            <div class="education-timeline">
              ${data.education
                .map((edu, index) => {
                  if (edu.degree) {
                    return `
                <div class="education-item" data-scroll style="transition-delay: ${
                  index * 0.15
                }s">
              ...
              `;
                ...
                <div class="education-item" data-scroll style="transition-delay: ${
                  ...
                  <p class="education-institution">${edu.company}</p>
                  <p class="education-period">${edu.period}</p>
                  <ul class="education-details">
                    ${edu.description
                      .map((desc) => `<li>${desc}</li>`)
